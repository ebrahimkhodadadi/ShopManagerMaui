    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoredProducts_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportLogger", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportLogger_Stores_DestinationStoreId",
                        column: x => x.DestinationStoreId,
                        principalTable: "Stores",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TransportLogger_Stores_SourceStoreId",
                        column: x => x.SourceStoreId,
                        principalTable: "Stores",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TransportLogger_Users_TransPorterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoredProducts_StoreId",
                table: "StoredProducts",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportLogger_DestinationStoreId",
                table: "TransportLogger",
                column: "DestinationStoreId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportLogger_SourceStoreId",
                table: "TransportLogger",
                column: "SourceStoreId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportLogger_TransPorterId",
                table: "TransportLogger",
